      ...
      integer grib_get_data
      external grib_get_data
      ...
      integer grib_get_real8_element
      external grib_get_real8_element
      ...
      integer grib_write
      external grib_write
      integer grib_multi_write
      external grib_multi_write
      integer grib_multi_append
      external grib_multi_append
