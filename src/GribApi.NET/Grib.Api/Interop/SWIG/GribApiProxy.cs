...
public class GribApiProxy {
  ...
  public static void GribGetStringArray(GribHandle h, string name, string[] val, ref SizeT length) {
    int ret = GribApiProxyPINVOKE.GribGetStringArray(h.Reference, name, val, ref  length.Value);
