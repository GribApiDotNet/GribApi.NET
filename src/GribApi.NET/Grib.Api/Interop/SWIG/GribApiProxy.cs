...
public class GribApiProxy {
  ...
  public static SWIGTYPE_p_grib_handle GribHandleNewFromMultiMessage(SWIGTYPE_p_grib_context c, SWIGTYPE_p_p_void data, SWIGTYPE_p_size_t data_len, out int error) {
    global::System.IntPtr cPtr = GribApiProxyPINVOKE.GribHandleNewFromMultiMessage(SWIGTYPE_p_grib_context.getCPtr(c), SWIGTYPE_p_p_void.getCPtr(data), SWIGTYPE_p_size_t.getCPtr(data_len), out error);
    SWIGTYPE_p_grib_handle ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_grib_handle(cPtr, false);
    return ret;
  }
  ...
  public static void GribGetMessage(SWIGTYPE_p_grib_handle h, SWIGTYPE_p_p_void message, SWIGTYPE_p_size_t message_length) {
    int ret = GribApiProxyPINVOKE.GribGetMessage(SWIGTYPE_p_grib_handle.getCPtr(h), SWIGTYPE_p_p_void.getCPtr(message), SWIGTYPE_p_size_t.getCPtr(message_length));
  ...
  public static void GribGetMessageCopy(SWIGTYPE_p_grib_handle h, SWIGTYPE_p_void message, SWIGTYPE_p_size_t message_length) {
    int ret = GribApiProxyPINVOKE.GribGetMessageCopy(SWIGTYPE_p_grib_handle.getCPtr(h), SWIGTYPE_p_void.getCPtr(message), SWIGTYPE_p_size_t.getCPtr(message_length));
